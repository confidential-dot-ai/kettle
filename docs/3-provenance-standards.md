...
{
  "builder": {
    "id": "https://confidential.ai/attested-builds/v1"
  }
}
```
...
A consumer's verification policy specifies which builder IDs they trust. The policy might say "I trust builds from https://confidential.ai/attested-builds/v1 at SLSA L3" while rejecting builds from other platforms.
